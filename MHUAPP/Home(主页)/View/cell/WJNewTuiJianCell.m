...
#define  width_width  kMSScreenWith*0.35   //height 200
...
- (void)setUpUI
{
    ...
    UILabel *lab_dianchui = LabelInit(ima_dian.Right-80, ima_dian.y+10,60, 21);
    ...
    UILabel *lab_dianmess = LabelInit(ima_dian.Right-100, lab_dianchui.Bottom+10,80, 21);
    lab_dianmess.text = @"愿你与美同行";
    lab_dianmess.font = Font(13);
    lab_dianmess.textAlignment = NSTextAlignmentRight;
    lab_dianmess.textColor = [RegularExpressionsMethod ColorWithHexString:@"FFF0E0"];
    ...
    _img_dianchui.image = [UIImage imageNamed:@"home_snap_img"];
    ...
    UILabel *lab_meijia = LabelInit(ima_meijia.x+20, ima_meijia.y+10,60, 21);
    lab_meijia.text = @"美甲类";
    ...
    UILabel *lab_meijiaMess = LabelInit(ima_meijia.x+20, lab_meijia.Bottom+10,80, 21);
    lab_meijiaMess.text = @"指甲美丽的秘密";
    lab_meijiaMess.font = Font(13);
    ...
    _img_meijia.image = [UIImage imageNamed:@"home_snap_img"];
    ...
    UILabel *lab_fuhu = LabelInit(ima_fuhu.Right-80, ima_fuhu.y+10,60, 21);
    lab_fuhu.text = @"护肤类";
    ...
    UILabel *lab_fuhumess = LabelInit(ima_fuhu.Right-100, lab_fuhu.Bottom+10,80, 21);
    lab_fuhumess.text = @"健康肌肤有你我有我";
    lab_fuhumess.font = Font(13);
    ...
    _img_fuhu.image = [UIImage imageNamed:@"home_snap_img"];
    ...
    UILabel *lab_meifa = LabelInit(ima_meifa.Right+20, ima_meifa.y+10,60, 21);
    lab_meifa.text = @"美发类";
    ...
    UILabel *lab_meifaMess = LabelInit(ima_meifa.x+20, lab_meifa.Bottom+10,80, 21);
    lab_meifaMess.text = @"愿你与美同行";
    lab_meifaMess.font = Font(13);
    ...
    _img_meifa.image = [UIImage imageNamed:@"home_snap_img"];
