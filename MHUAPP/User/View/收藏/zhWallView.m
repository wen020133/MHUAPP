...
- (void)setModel:(zhWallItemModel *)model
    ...
    [_imageView setBackgroundImage:[UIImage createImageWithColor:appearance.imageViewBackgroundColor] forState:UIControlStateNormal];
    [_imageView setBackgroundImage:[UIImage createImageWithColor:appearance.imageViewHighlightedColor] forState:UIControlStateHighlighted];
    ...
    _imageView.dc_centerX = layout.itemSize.width / 2;
    if (_textLabel.text.length > 0) {
        ...
        _textLabel.dc_centerX = layout.itemSize.width / 2;
    }
}
