...
#import "WJImagePickerSheet.h"

@interface WJImagePickerSheet()<UINavigationControllerDelegate, UIImagePickerControllerDelegate>

@end

@implementation WJImagePickerSheet
-(instancetype)init{
    self = [super init];
    if (self) {
        if (!_arrSelected) {
