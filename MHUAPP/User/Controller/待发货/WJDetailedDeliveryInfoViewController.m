...
-(void)getDetailedDeliveryInfo
{
    ...
    [self requestGetAPIWithServe:[NSString stringWithFormat:@"%@/%@/%@?order_sn=%@&user_id=%@",kMSBaseMiYoMeiPortURL,kMSappVersionCode,kMSGetDetailedDelivery,_str_orderId,uid]];
}
