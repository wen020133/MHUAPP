//
//  WJOrderSuccessViewController.m
//  MHUAPP
//
//  Created by wenchengjun on 2018/6/9.
...
@interface WJOrderSuccessViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation WJOrderSuccessViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [RegularExpressionsMethod ColorWithHexString:kMSVCBackgroundColor];
    [self initSendReplyWithTitle:@"交易成功" andLeftButtonName:@"ic_back.png" andRightButtonName:nil andTitleLeftOrRight:YES];
...
-(void)getDetailedReceiveInfo
{
    ...
    [self requestGetAPIWithServe:[NSString stringWithFormat:@"%@/%@/%@?id=%@&user_id=%@",kMSBaseMiYoMeiPortURL,kMSappVersionCode,kMSOrderInfo,_order_id,uid]];
}
