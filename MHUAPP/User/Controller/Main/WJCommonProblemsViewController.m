...
{
    [self requestGetAPIWithServe:[NSString stringWithFormat:@"%@/%@/%@?user_id=%@",kMSBaseMiYoMeiPortURL,kMSappVersionCode,kMSetArticle,[AppDelegate shareAppDelegate].user_id]];
}
-(void)getProcessData
{
