...
-(instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        _lab_title= [[UILabel alloc]initWithFrame:CGRectMake(_img_content.Right+5, 135, kMSScreenWith-130, 20)];
        ...
        _lab_price = [[UILabel alloc]initWithFrame:CGRectMake(_img_content.Right+5, _lab_describe.Bottom+10, 80, 20)];
        ...
        _lab_count = [[UILabel alloc]initWithFrame:CGRectMake(_lab_price.Right+5, _lab_describe.Bottom+10, 100, 20)];
