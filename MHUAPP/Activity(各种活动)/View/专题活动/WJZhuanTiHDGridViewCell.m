...
@interface WJZhuanTiHDGridViewCell()
/** 个数 */
...
@implementation WJZhuanTiHDGridViewCell
- (instancetype)initWithFrame:(CGRect)frame {

    self = [super initWithFrame:frame];
    if (self) {
        _defaultImgArr = @[@"zthd_meifagongju",@"zthd_meirongyiqi",@"zthd_xifadingxing",@"zthd_ranfatangfa",@"zthd_xihuxiangshui",@"zthd_meizhuanghuli",@"zthd_meijiawenxiu",@"zthd_other"];
        _defaultTitleArr = @[@"美发工具",@"美容仪器",@"洗发定型",@"染发烫发",@"洗护香水",@"美妆护理",@"美甲纹绣",@"其他"];
