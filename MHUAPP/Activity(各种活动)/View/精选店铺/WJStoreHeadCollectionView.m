...
@interface WJStoreHeadCollectionView()<SDCycleScrollViewDelegate>
...
-(void)setUpUI
{
    ...
    _view_head = [[UIView alloc]initWithFrame:CGRectMake(0, 0, kMSScreenWith, 240)];
    ...
    UIImageView *baalpha = ImageViewInit(0, 180, kMSScreenWith, 60);
    ...
    for (int aa=0; aa<arrTitle.count; aa++) {
        UIImageView *line = [[UIImageView alloc] initWithFrame:CGRectMake(kMSScreenWith/4*(aa+1), 180, 1, 60)];
        line.backgroundColor = [RegularExpressionsMethod ColorWithHexString:@"E6E6E6"];
        [_view_head addSubview:line];
        
        UILabel *labMyOrder = [[UILabel alloc] initWithFrame:CGRectMake(kMSScreenWith/4*aa, 190, kMSScreenWith/4, 20)];
    ...
    _lab_allGood = [[UILabel alloc] initWithFrame:CGRectMake(0, 210, kMSScreenWith/4, 30)];
    ...
    _lab_allGood.font = Font(14);
    [_view_head addSubview:_lab_allGood];
    
    _lab_shangjiaMiaosuNum = [[UILabel alloc] initWithFrame:CGRectMake(kMSScreenWith/4, 210, kMSScreenWith/4, 30)];
    ...
    _lab_shangjiaMiaosuNum.font = Font(14);
    _lab_shangjiaMiaosuNum.text = @"5.0";
    [_view_head addSubview:_lab_shangjiaMiaosuNum];
    
    _lab_fuwuNum = [[UILabel alloc] initWithFrame:CGRectMake(kMSScreenWith/2, 210, kMSScreenWith/4, 30)];
    ...
    _lab_fuwuNum.font = Font(14);
    _lab_fuwuNum.text = @"5.0";
    [_view_head addSubview:_lab_fuwuNum];
    
    _lab_wlSuduNum = [[UILabel alloc] initWithFrame:CGRectMake(kMSScreenWith/4*3, 210, kMSScreenWith/4, 30)];
